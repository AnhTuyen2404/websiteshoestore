        ...
        <main id="MainContent" class="content-for-layout">
            ...
            <div class="slideshow-section position-relative">
                <div class="slideshow-active activate-slider" data-slick='{
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="{{('client/img/slideshow/s1.jpg')}}" alt="slide-1">
                        <img class="slide-img d-md-none" src="{{('client/img/slideshow/s1-m.jpg')}}" alt="slide-1">
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="{{('client/img/slideshow/s2.jpg')}}" alt="slide-2">
                        <img class="slide-img d-md-none" src="{{('client/img/slideshow/s2-m.jpg')}}" alt="slide-2">
                        <div class="content-absolute content-slide">
                            <div class="container height-inherit d-flex align-items-center">
                                <div class="content-box slide-content py-4">
                                    <h2 class="slide-heading heading_72 animate__animated animate__fadeInUp"
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="{{('client/img/slideshow/s3.jpg')}}" alt="slide-3">
                        <img class="slide-img d-md-none" src="{{('client/img/slideshow/s3-m.jpg')}}" alt="slide-3">
                        <div class="content-absolute content-slide">
                            <div class="container height-inherit d-flex align-items-center">
                                <div class="content-box slide-content py-4">
                                    <h2 class="slide-heading heading_72 animate__animated animate__fadeInUp"
                        ...
                        <div class="row justify-content-center trusted-row">
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="trusted-badge bg-trust-1 rounded">
                                    <div class="trusted-icon">
                                        <img class="icon-trusted" src="client/img/trusted/1.png')}}" alt="icon-1">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="trusted-badge bg-trust-2 rounded">
                                    <div class="trusted-icon">
                                        <img class="icon-trusted" src="{{('client/img/trusted/2.png')}}" alt="icon-2">
                                    </div>
                                    <div class="trusted-content">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="trusted-badge bg-trust-3 rounded">
                                    <div class="trusted-icon">
                                        <img class="icon-trusted" src="{{('client/img/trusted/3.png')}}" alt="icon-3">
                                    </div>
                                    <div class="trusted-content">
                        ...
                        <div class="row">
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/9.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/1.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/10.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/2.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/11.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/3.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/14.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/4.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/15.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/5.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/16.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/6.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/17.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/7.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-6 col-6" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/19.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/8.jpg')}}"
                                                alt="product-img">
                                        </a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-6 col-12" data-aos="fade-right" data-aos-duration="1200">
                                <a class="banner-item position-relative rounded" href="collection-left-sidebar.html">
                                    <img class="banner-img" src="{{('client/img/banner/shoe-1.jpg')}}" alt="banner-1">
                                    <div class="content-absolute content-slide">
                                        <div class="container height-inherit d-flex align-items-center">
                            ...
                            <div class="col-lg-6 col-md-6 col-12" data-aos="fade-left" data-aos-duration="1200">
                                <a class="banner-item position-relative rounded" href="collection-left-sidebar.html">
                                    <img class="banner-img" src="{{('client/img/banner/shoe-2.jpg')}}" alt="banner-2">
                                    <div class="content-absolute content-slide">
                                        <div class="container height-inherit d-flex align-items-center">
                                            <div class="content-box banner-content p-4">
                                                <p class="heading_18 mb-3 text-white">Sports Shoes</p>
                          ...
                          },
                          {
                            ...
                            <div class="new-item" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/1.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/20.jpg')}}"
                                                alt="product-img">
                                        </a>
                                ...
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/10.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/21.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="new-item" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/7.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/17.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="new-item" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/2.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/22.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="new-item" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/3.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/23.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="new-item" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/4.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/24.jpg')}}"
                                                alt="product-img">
                                        </a>
                            ...
                            <div class="new-item" data-aos="fade-up" data-aos-duration="700">
                                <div class="product-card">
                                    <div class="product-card-img">
                                        <a class="hover-switch" href="collection-left-sidebar.html">
                                            <img class="secondary-img" src="{{('client/img/products/shoe/5.jpg')}}"
                                                alt="product-img">
                                            <img class="primary-img" src="{{('client/img/products/shoe/25.jpg')}}"
                                                alt="product-img">
                                        </a>
            ...
            <div class="single-banner-section mt-100 overflow-hidden">
                <div class="position-relative overlay">
                    <img class="single-banner-img" src="{{('client/img/banner/single-banner.jpg')}}" alt="slide-1">
                        ...
                        <div class="instagram-container position-relative mt-48">
                            <div class="common-slider" data-slick='{
                                ...
                                <div class="instagram-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="instagram-card">
                                        <a class="instagram-img-wrapper" href="index-shoe.html">
                                            <img src="{{('client/img/instagram/s1.jpg')}}" alt="img"
                                ...
                                <div class="instagram-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="instagram-card">
                                        <a class="instagram-img-wrapper" href="index-shoe.html">
                                            <img src="{{('client/img/instagram/s2.jpg')}}" alt="img"
                                                class="instagram-card-img rounded">
                                        </a>
                                    </div>
                                </div>
                                <div class="instagram-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="instagram-card">
                                        <a class="instagram-img-wrapper" href="index-shoe.html">
                                            <img src="{{('client/img/instagram/s3.jpg')}}" alt="img"
                                                class="instagram-card-img rounded">
                                        </a>
                                    </div>
                                </div>
                                <div class="instagram-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="instagram-card">
                                        <a class="instagram-img-wrapper" href="index-shoe.html">
                                            <img src="{{('client/img/instagram/s4.jpg')}}" alt="img"
                                                class="instagram-card-img rounded">
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="newsletter-section mt-100 overflow-hidden">
                <div class="newsletter-inner">
                    <div class="position-relative">
                        <img class="single-banner-img" src="{{('client/img/newsletter/2.jpg')}}" alt="slide-1">
                            ...
                            <div class="scroll-horizontal row align-items-center flex-nowrap">
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                                    ...
                                    <a href="index-shoe.html" class="brand-logo d-flex align-items-center justify-content-center">
                                        <img src="{{('client/img/brand/1.png')}}" alt="img">
                                    </a>
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                                    data-aos-duration="700">
                                    <a href="index-shoe.html" class="brand-logo d-flex align-items-center justify-content-center">
                                        <img src="{{('client/img/brand/2.png')}}" alt="img">
                                    </a>
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                                    data-aos-duration="700">
                                    <a href="index-shoe.html" class="brand-logo d-flex align-items-center justify-content-center">
                                        <img src="{{('client/img/brand/3.png')}}" alt="img">
                                    </a>
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                                    data-aos-duration="700">
                                    <a href="index-shoe.html" class="brand-logo d-flex align-items-center justify-content-center">
                                        <img src="{{('client/img/brand/4.png')}}" alt="img">
                                    </a>
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                                    data-aos-duration="700">
                                    <a href="index-shoe.html" class="brand-logo d-flex align-items-center justify-content-center">
                                        <img src="{{('client/img/brand/5.png')}}" alt="img">
                                    </a>
                                </div>
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-6" data-aos="fade-up"
                                    data-aos-duration="700">
                                    <a href="index-shoe.html" class="brand-logo d-flex align-items-center justify-content-center">
                                        <img src="{{('client/img/brand/6.png')}}" alt="img">
                                    </a>
                                </div>
                            </div>
                        </div>
