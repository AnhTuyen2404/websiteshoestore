                        ...
                        <div class="col-lg-3 col-md-4 col-4">
                            <div class="header-logo">
                                <a href="{{URL::to('/')}}" class="logo-main">
                                    <img src="{{('client/img/logo.png')}}" loading="lazy" alt="bisum">
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-logo">
                                        <a href="/"><img src="{{('client/img/logo-white.png')}}" alt="bisum"></a>
                                    </h4>
                    ...
                    <ul class="utility-menu list-unstyled">
                        ...
                        <li class="utilty-menu-item">
                            <button type="button" class="currency-btn btn-reset" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img class="flag" src="{{('client/img/flag/usd.jpg')}}" alt="img">
                                <span>USD</span>
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg" width="24"
                                    ...
                                    <div class="product-img-large">
                                        <div class="qv-large-slider img-large-slider common-slider" data-slick='{
                                            ...
                                            <div class="img-large-wrapper">
                                                <img src="{{('client/img/products/bags/39.jpg')}}" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="{{('client/img/products/bags/38.jpg')}}" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="{{('client/img/products/bags/37.jpg')}}" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="{{('client/img/products/bags/36.jpg')}}" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="{{('client/img/products/bags/34.jpg')}}" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="{{('client/img/products/bags/30.jpg')}}" alt="img">
                                            </div>
                                            <div class="img-large-wrapper">
                                                <img src="{{('client/img/products/bags/32.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-12">
                                <div class="product-details ps-lg-4">
                                    ...
                                    <div class="misc d-flex align-items-end justify-content-between mt-4">
                                        <div class="quantity d-flex align-items-center justify-content-between">
                                            <button class="qty-btn dec-qty"><img src="{{('client/img/icon/minus.svg')}}" alt="minus"></button>
                                            <input class="qty-input" type="number" name="qty" value="1" min="0">
                                            <button class="qty-btn inc-qty"><img src="{{('client/img/icon/plus.svg')}}" alt="plus"></button>
                                        </div>
