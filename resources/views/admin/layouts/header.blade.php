{{-- <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      {{-- <div class="topbar-divider d-none d-sm-block"><span class="mr-2 d-none d-lg-inline text-gray-600 small"></span>
        <img style="width: 40px;height: 40px;" class="img-profile rounded-circle" src="{{asset('backend/img/admin.jpg')}}">
